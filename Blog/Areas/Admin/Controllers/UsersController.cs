...
namespace Blog.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateUserViewModel model)
        {
            ...
            {
                ApplicationUser user = new ApplicationUser { Email = model.Email, UserName = model.Email, AppUserName = model.AppUserName };
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            EditUserViewModel model = new EditUserViewModel { Id = user.Id, Email = user.Email, AppUserName = user.AppUserName };
            return View(model);
        }
